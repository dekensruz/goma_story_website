// Fichier JavaScript spécifique pour la page Histoire
document.addEventListener('DOMContentLoaded', function() {
    // Vérifier si nous sommes sur la page histoire
    if (document.querySelector('.histoire-main')) {
        // Animer les sections au défilement
        const sections = document.querySelectorAll('.histoire-section');
